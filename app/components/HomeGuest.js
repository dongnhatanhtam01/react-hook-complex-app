...
function HomeGuest() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      await Axios.post("http://localhost:8080/register", { username:'test2', email:"test2@test.com", password:"qwerty123456" }).then((response) => {
  ...
  return (
    <UseEffectPage title="HomeGuest" wide={true} >
